...
PREBUILT_DIR="${ROOT_DIR}/third_party/audio/prebuilt/libogg/${PLATFORM}"
...
for header in ogg.h os_types.h config_types.h; do
	check_file_exists "${PREBUILT_DIR}/include/ogg/${header}"
done

check_not_lfs_pointer "${PREBUILT_DIR}/lib/libogg.a"
