...
for header in opus.h opus_defines.h opus_multistream.h opus_projection.h opus_types.h; do
	check_file_exists "${PREBUILT_DIR}/include/opus/${header}"
done

check_not_lfs_pointer "${PREBUILT_DIR}/lib/libopus.a"
