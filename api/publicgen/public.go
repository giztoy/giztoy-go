...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc("GET "+options.BaseURL+"/download/firmware/{path}", wrapper.DownloadFirmware)
	m.HandleFunc("GET "+options.BaseURL+"/info", wrapper.GetInfo)
	m.HandleFunc("PUT "+options.BaseURL+"/info", wrapper.PutInfo)
	m.HandleFunc("GET "+options.BaseURL+"/ota", wrapper.GetOTA)
	m.HandleFunc("POST "+options.BaseURL+"/register", wrapper.RegisterGear)
	m.HandleFunc("GET "+options.BaseURL+"/registration", wrapper.GetRegistration)
	m.HandleFunc("GET "+options.BaseURL+"/runtime", wrapper.GetRuntime)
	m.HandleFunc("GET "+options.BaseURL+"/server-info", wrapper.GetServerInfo)
