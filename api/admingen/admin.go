...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc("GET "+options.BaseURL+"/firmwares", wrapper.ListDepots)
	m.HandleFunc("GET "+options.BaseURL+"/firmwares/{depot}", wrapper.GetDepot)
	m.HandleFunc("PUT "+options.BaseURL+"/firmwares/{depot}", wrapper.PutDepotInfo)
	m.HandleFunc("GET "+options.BaseURL+"/firmwares/{depot}/{channel}", wrapper.GetChannel)
	m.HandleFunc("PUT "+options.BaseURL+"/firmwares/{depot}/{channel}", wrapper.PutChannel)
	m.HandleFunc("PUT "+options.BaseURL+"/firmwares/{depot}:release", wrapper.ReleaseDepot)
	m.HandleFunc("PUT "+options.BaseURL+"/firmwares/{depot}:rollback", wrapper.RollbackDepot)
