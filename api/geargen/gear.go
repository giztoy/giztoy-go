...
func (siw *ServerInterfaceWrapper) ListByCertification(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "authority", r.PathValue("authority"), &authority, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) ListByFirmware(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "depot", r.PathValue("depot"), &depot, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) ResolveByIMEI(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "tac", r.PathValue("tac"), &tac, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) ResolveBySN(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "sn", r.PathValue("sn"), &sn, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) DeleteGear(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "publicKey", r.PathValue("publicKey"), &publicKey, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc("GET "+options.BaseURL+"/gears", wrapper.ListGears)
	m.HandleFunc("GET "+options.BaseURL+"/gears/certification/{type}/{authority}/{id}", wrapper.ListByCertification)
	m.HandleFunc("GET "+options.BaseURL+"/gears/firmware/{depot}/{channel}", wrapper.ListByFirmware)
	m.HandleFunc("GET "+options.BaseURL+"/gears/imei/{tac}/{serial}", wrapper.ResolveByIMEI)
	m.HandleFunc("GET "+options.BaseURL+"/gears/label/{key}/{value}", wrapper.ListByLabel)
	m.HandleFunc("GET "+options.BaseURL+"/gears/sn/{sn}", wrapper.ResolveBySN)
	m.HandleFunc("DELETE "+options.BaseURL+"/gears/{publicKey}", wrapper.DeleteGear)
	m.HandleFunc("GET "+options.BaseURL+"/gears/{publicKey}", wrapper.GetGear)
	m.HandleFunc("GET "+options.BaseURL+"/gears/{publicKey}/config", wrapper.GetGearConfig)
	m.HandleFunc("PUT "+options.BaseURL+"/gears/{publicKey}/config", wrapper.PutGearConfig)
	m.HandleFunc("GET "+options.BaseURL+"/gears/{publicKey}/info", wrapper.GetGearInfo)
	m.HandleFunc("GET "+options.BaseURL+"/gears/{publicKey}/ota", wrapper.GetGearOTA)
	m.HandleFunc("GET "+options.BaseURL+"/gears/{publicKey}/runtime", wrapper.GetGearRuntime)
	m.HandleFunc("POST "+options.BaseURL+"/gears/{publicKey}:approve", wrapper.ApproveGear)
	m.HandleFunc("POST "+options.BaseURL+"/gears/{publicKey}:block", wrapper.BlockGear)
	m.HandleFunc("POST "+options.BaseURL+"/gears/{publicKey}:refresh", wrapper.RefreshGear)
