...
func TestPublicAndAdminErrorHandlers(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "server info method not allowed", pk: devicePK, target: func() http.Handler { return srv.publicHandler(devicePK) }, method: http.MethodPost, path: "/server-info", want: http.StatusBadRequest},
		...
		{name: "registration wrong method", pk: devicePK, target: func() http.Handler { return srv.publicHandler(devicePK) }, method: http.MethodPost, path: "/registration", want: http.StatusBadRequest},
		...
		{name: "runtime wrong method", pk: devicePK, target: func() http.Handler { return srv.publicHandler(devicePK) }, method: http.MethodPost, path: "/runtime", want: http.StatusBadRequest},
		{name: "config wrong method", pk: devicePK, target: func() http.Handler { return srv.publicHandler(devicePK) }, method: http.MethodPost, path: "/config", want: http.StatusBadRequest},
		...
		{name: "ota wrong method", pk: devicePK, target: func() http.Handler { return srv.publicHandler(devicePK) }, method: http.MethodPost, path: "/ota", want: http.StatusBadRequest},
		...
		{name: "download wrong method", pk: devicePK, target: func() http.Handler { return srv.publicHandler(devicePK) }, method: http.MethodPost, path: "/download/firmware/firmware.bin", want: http.StatusBadRequest},
		...
		{name: "admin gears wrong method", pk: adminPK, target: func() http.Handler { return srv.adminHandler(adminPK) }, method: http.MethodPost, path: "/gears", want: http.StatusBadRequest},
