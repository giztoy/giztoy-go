...
func buildSchemaHint(schema *Schema) string {
	...
	sb.WriteString("The following entity types and attributes are expected. Use these as guidance, but you may also discover entities and attributes beyond this schema.\n\n")
